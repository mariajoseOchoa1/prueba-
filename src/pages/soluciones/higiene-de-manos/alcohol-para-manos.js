...
<SplitSection
      ...
      primarySlot={
        <div className="bg-white bg-opacity-50 rounded-lg px-6 pt-8 pb-6 ml-25">
          <h1 className="font-bold text-xl text-center">Alcohol para Manos Dr.Clean </h1>
          ...
          El alcohol para manos Dr. Clean® es ideal para la desinfección de manos ya que está formulado con el poderoso efecto bactericida y viricida+ del etanol (69.9% v/v), combinado de la acción hidratante de la glicerina. Producto de aplicación directa, es más delicado al contacto con la piel que el alcohol ordinario. Usado correctamente permite una reducción de 99,9% de microorgismos*. Uso externo y cosmético solamente. No requiere enjuague.
          </p>
          <br/>
      ...
      secondarySlot={<PictureWebp className="" filename="alcohol-para-manos" description="Imagen del producto alcohol para manos Dr.Clean "/>}
/>
