...
<SplitSection
      ...
      primarySlot={
        <div className="bg-white bg-opacity-50 rounded-lg px-6 pt-8 pb-6 ml-25">
          <h1 className="font-bold text-xl text-center">Limpión Industrial Biosolutions </h1>
          <h2 className="font-semibold text-lg text-secondary text-center">color natural</h2>
          <p className="mt-8 text-md font-light leading-relaxed text-justify">
          Limpión de papel en rollo ideal para limpiar y secar. Es un producto 100% biodegradable, con soluciones ecológicas de higiene en suavidad y textura para mayor bienestar en la limpieza. Elaborado con procesos ecológicos y socialmente responsables.
          </p>
          <br/>
      ...
      secondarySlot={<PictureWebp className="" filename="limpion-industrial-bio" description="Imagen del producto limpión industrial bio "/>}
/>
