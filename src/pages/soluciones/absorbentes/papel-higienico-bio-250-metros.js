...
<SplitSection
      ...
      primarySlot={
        <div className="bg-white bg-opacity-50 rounded-lg px-6 pt-8 pb-6 ml-25">
          <h1 className="font-bold text-xl text-center">Papel Higiénico Biosolutions</h1>
          <h2 className="font-semibold text-lg text-secondary text-center">250 metros color blanco</h2>
          <p className="mt-8 text-md font-light leading-relaxed text-justify">
          Papel higiénico 250 metros x4 unidades o x1 unidad. Es un producto 100% biodegradable, con soluciones ecológicas de higiene en suavidad y textura para mayor bienestar en cuidado personal. Elaborado con procesos ecológicos y socialmente responsables. Su materia prima es 80% reciclada de celulosa.
          </p>
          <br/>
      ...
      secondarySlot={<PictureWebp className="" filename="papel-higienico-250-metros-bio" description="Imagen del producto papel higiénico bio 250 metros "/>}
/>
