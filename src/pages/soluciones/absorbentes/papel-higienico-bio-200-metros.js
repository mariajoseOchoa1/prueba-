...
<SplitSection
      ...
      primarySlot={
        <div className="bg-white bg-opacity-50 rounded-lg px-6 pt-8 pb-6 ml-25">
          <h1 className="font-bold text-xl text-center">Papel Higiénico Bisolutions </h1>
          <h2 className="font-semibold text-lg text-secondary text-center">200 metros color blanco</h2>
      ...
      secondarySlot={<PictureWebp className="" filename="papel-higienico-200-metros-bio" description="Imagen del producto papel higiénico bio 200 metros "/>}
/>
