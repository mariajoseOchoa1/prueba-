...
<SplitSection
      ...
      primarySlot={
        <div className="bg-white bg-opacity-50 rounded-lg px-6 pt-8 pb-6 ml-25">
          <h1 className="font-bold text-xl text-center">Servilleta Dispensada </h1>
          <h2 className="font-semibold text-lg text-secondary text-center">en Z color blanco</h2>
      ...
      secondarySlot={<PictureWebp className="" filename="servilleta-dispensada" description="Imagen del producto servilleta dispensada en z "/>}
/>
