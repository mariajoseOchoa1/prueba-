...
<SplitSection
      ...
      primarySlot={
        <div className="bg-white bg-opacity-50 rounded-lg px-6 pt-8 pb-6 ml-25">
          <h1 className="font-bold text-xl text-center">Suavizante de Ropa Ozz</h1>
          <h2 className="font-semibold text-lg text-secondary text-center">suavizante de fibras textiles.</h2>
      ...
      secondarySlot={<PictureWebp className="" filename="suavizante-de-ropa" description="Imagen del producto suavizante de ropa Ozz "/>}
/>
