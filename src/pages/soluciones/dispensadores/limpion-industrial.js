...
<SplitSection
      ...
      primarySlot={
        <div className="bg-white bg-opacity-50 rounded-lg px-6 pt-8 pb-6 ml-25">
          <h1 className="font-bold text-xl text-center">Dispensador de Limpión Insdustrial </h1>
          <h2 className="font-semibold text-lg text-secondary text-center">ideal para rollos de 300 y 600 metros.</h2>
          <p className="mt-8 text-md font-light leading-relaxed text-justify">
          Dispensador que brinda soluciones adecuadas para el limpión, modelo robusto y de gran capacidad con mantenimiento mínimo, su pre-picado facilita el corte. Permite ahorrar costos y mejorar la higiene. Adecuado para poder equipar en cualquier lugar de la cocina.
          </p>
          <br/>
      ...
      secondarySlot={<PictureWebp className="" filename="dispensador-limpion-industrial" description="Imagen del producto dispensador para limpión industrial "/>}
/>
