...
<SplitSection
      ...
      primarySlot={
        <div className="bg-white bg-opacity-50 rounded-lg px-6 pt-8 pb-6 ml-25">
          <h1 className="font-bold text-xl text-center">Dispensador de Jabón Espuma Unilimpio </h1>
          <h2 className="font-semibold text-lg text-secondary text-center">para sachet de 800ml de jabón espuma</h2>
          <p className="mt-8 text-md font-light leading-relaxed text-justify">
          Dispensador de jabón espuma ideal para todo tipo de ambientes. Ideal para todo tipo de decoraciones en el sector de salud, hoteles, restaurantes y planteles educativos. Gracias a su sistema de dosificación, cada push arroja un ml del producto, lo que permite ahorrar el consumo de jabón.
          </p>
          <br/>
      ...
      secondarySlot={<PictureWebp className="" filename="dispensador-jabon-espuma-unilimpio" description="Imagen del producto dispensador de jabón espuma Unilimpio "/>}
/>
