...
<SplitSection
      ...
      primarySlot={
        <div className="bg-white bg-opacity-50 rounded-lg px-6 pt-8 pb-6 ml-25">
          <h1 className="font-bold text-xl text-center">Dispensador Premium para Papel Higiénico Jumbo</h1>
          <h2 className="font-semibold text-lg text-secondary text-center">color metálico</h2>
      ...
      secondarySlot={<PictureWebp className="" filename="dispensador-ph-premium" description="Imagen del producto dispensador premium para papel higiénico Unilimpio"/>}
/>
