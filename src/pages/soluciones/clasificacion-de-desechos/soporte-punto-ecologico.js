...
<SplitSection
      ...
      primarySlot={
        <div className="bg-white bg-opacity-50 rounded-lg px-6 pt-8 pb-6 ml-25">
          <h1 className="font-bold text-xl text-center">Soporte Punto Ecológico </h1>
          <h2 className="font-semibold text-lg text-secondary text-center">permite clasificar diferentes tipos de residuos.</h2>
          <p className="mt-8 text-md font-light leading-relaxed text-justify">
          Ideal para 3 contenedores de tapa vaivén de 35 a 53 litros. El soporte punto ecológico permite crear un estante firme y estable para los contendores de tapa vaivén de 35 y 53 litros. El rótulo del soporte constituye una excelente señalización que motiva al público a depositar organizadamente sus residuos en las diferentes categorías. Adicional, podemos personalizar el rótulo del soporte con el logotipo de la institución. Poseen diseños elegantes que armonizan los espacios públicos y privados, como son: escuelas, colegios, empresas, oficinas, etc. Los soportes ecológicos pueden ubicarlos en el interior o exterior del establecimiento. Fabricados en material protegido con pintura anticorrosiva para su mayor duración.
          </p>
          <br/>
      ...
      secondarySlot={<PictureWebp className="" filename="soporte-punto-ecologico" description="Imagen del producto soporte punto ecológico"/>}
/>
