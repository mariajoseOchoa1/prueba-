...
<SplitSection
      ...
      primarySlot={
        <div className="bg-white bg-opacity-50 rounded-lg px-6 pt-8 pb-6 ml-25">
          <h1 className="font-bold text-xl text-center">Contenedores con Tapa Vaivén </h1>
          <h2 className="font-semibold text-lg text-secondary text-center">ideal para almacenar desechos moderados.</h2>
          <p className="mt-8 text-md font-light leading-relaxed text-justify">
          Contenedores de residuos con tapa vaivén. Posee un sistema de apertura manual con un simple toque. Diseño rectangular que ayuda a optimizar los espacios, contiene un soporte para la bolsa que garantiza el agarre y oculta sus bordes al interior del contenedor. Se los puede combinar con un soporte de punto ecológico, para exteriores e interiores. Contiene una tapa vaivén. Fabricados en material impermeable de fácil limpieza con protección contra el moho y la corrosión. Disponible en varios colores y tamaños.
          </p>
          <br/>
      ...
      secondarySlot={<PictureWebp className="" filename="contenedor-tapa-vaiven" description="Imagen del producto contenedor con tapa vaiven "/>}
/>
