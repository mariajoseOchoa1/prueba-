...
<SplitSection
      ...
      primarySlot={
        <div className="bg-white bg-opacity-50 rounded-lg px-6 pt-8 pb-6 ml-25">
          <h1 className="font-bold text-xl text-center">Fundas Plásticas </h1>
          <h2 className="font-semibold text-lg text-secondary text-center">de diferentes colores para contención de basura. </h2>
          <p className="mt-8 text-md font-light leading-relaxed text-justify">
          Funda plástica ideales para la recolección de basura acordes a las leyes de desechos. Ideal para el uso doméstico o industrial. Posee un sistema anti goteo en su fondo, evitando de esta manera que el goteo de la funda al momento de ubicar desechos que contienen residuos líquidos. Producto elaborado con polietileno de baja densidad.
          </p>
          <br/>
      ...
      secondarySlot={<PictureWebp className="" filename="fundas-de-basura" description="Imagen del producto fundas de basura"/>}
/>
