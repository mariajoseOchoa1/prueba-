...
<SplitSection
      ...
      primarySlot={
        <div className="bg-white bg-opacity-50 rounded-lg px-6 pt-8 pb-6 ml-25">
          <h1 className="font-bold text-xl">Center Pull</h1>
          <h2 className="font-semibold text-lg text-secondary">Toalla de manos de papel color blanco</h2>
      ...
      secondarySlot={<PictureWebp className="" filename="toalla-de-manos-center-pull" description="Imagen del producto toalla de manos center pull "/>}
/>
