...
<SplitSection
      ...
      primarySlot={
        <div className="bg-white bg-opacity-50 rounded-lg px-6 pt-8 pb-6 ml-25">
          <h1 className="font-bold text-xl text-center">Contenedores con Pedal </h1>
          ...
          Contenedores individuales con pedal diseñados de modo que, al estar tapados o cerrados, no permite la entrada de agua, insectos o roedores, ni el escape de líquidos por sus paredes o por el fondo. Poseen diseños elegantes que armonizan la decoración de las en oficinas, cocinas y recintos de trabajo. Fabricados en material impermeable de fácil limpieza con protección contra el moho y la corrosión. Disponible en varios colores y tamaños.
          </p>
          <br/>
      ...
      secondarySlot={<PictureWebp className="" filename="contenedor-pedal" description="Imagen del producto contenedores para clasificación de residuos con pedal "/>}
/>
