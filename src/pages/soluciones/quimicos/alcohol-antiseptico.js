...
<SplitSection
      ...
      primarySlot={
        <div className="bg-white bg-opacity-50 rounded-lg px-6 pt-8 pb-6 ml-25">
          <h1 className="font-bold text-xl text-center">Alcohol Multipropósito Ozz </h1>
          <h2 className="font-semibold text-lg text-secondary text-center">antiséptico al 72%</h2>
          <p className="mt-8 text-md font-light leading-relaxed text-justify">
          Alcohol Multipropositos Ozz es un desinfectante de superficies lisas y duras, a base de *etanol al 72 % (v/v), desinfecta todo tipo de superficies sin dejar residuos ya que se evapora inmediatamente, ideal para disminuir el riesgo de contaminación indirecta de enfermedades por contacto de superficies contaminadas. Usado correctamente, permite eliminar el 99,9 % de microorganismos**, incluyendo virus envueltos como el SARS-CoV2 causante del Covid-19+.
          </p>
          <br/>
      ...
      secondarySlot={<PictureWebp className="" filename="alcohol-antiseptico" description="Imagen del producto alcohol antiseptico ozz "/>}
/>
