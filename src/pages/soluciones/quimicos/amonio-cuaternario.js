...
<SplitSection
      ...
      primarySlot={
        <div className="bg-white bg-opacity-50 rounded-lg px-6 pt-8 pb-6 ml-25">
          <h1 className="font-bold text-xl text-center">Ozz Desinfectante de superficies ultra-concentrado </h1>
      ...
      secondarySlot={<PictureWebp className="" filename="amonio-cuaternario" description="Imagen del producto Ozz desinfectante de superficies grado alimenticio ultra-concentrado "/>}
/>
