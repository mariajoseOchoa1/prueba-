...
<SplitSection
      ...
      primarySlot={
        <div className="bg-white bg-opacity-50 rounded-lg px-6 pt-8 pb-6 ml-25">
          <h1 className="font-bold text-xl text-center">Sanitizante Peracético Ozz </h1>
          <h2 className="font-semibold text-lg text-secondary text-center">Sanitizante y desinfectante de superficies</h2>
          <p className="mt-8 text-md font-light leading-relaxed text-justify">
          Sanitizante Peracético Ozz® es un producto de excelente efectividad debido a su formulación basada en peróxido de hidrogeno, disminuye la carga microbiana en hasta 5 log (99.999%). Efectivo contra microorganismos*, producto de amplio espectro, trabaja a temperaturas desde 4 – 40 °C, reduciendo los costos de energía cuando es usado a bajas temperaturas. Su ingrediente activo está aprobado por la FDA como un “aditivo indirecto para alimentos y como desinfectante de superficies en la industria alimenticia”. No corrosivo para aceros inoxidables.
          </p>
          <br/>
      ...
      secondarySlot={<PictureWebp className="" filename="sanitizante-peracetico" description="Imagen del producto sanitizante peracético ozz "/>}
/>
