...
<SplitSection
      ...
      primarySlot={
        <div className="bg-white bg-opacity-50 rounded-lg px-6 pt-8 pb-6 ml-25">
          <h1 className="font-bold text-xl text-center">Lavavajilla Ozz </h1>
          <h2 className="font-semibold text-lg text-secondary text-center">jabón líquido neutro</h2>
          <p className="mt-8 text-md font-light leading-relaxed text-justify">
          Lavavajillas Ozz es un detergente líquido, formulado especialmente para el lavado y limpieza de vajillas y utensilios de cocina. Es fácil de enjuagar y no deja película residual, permitiendo el secado al ambiente. Por su composición deja la vajilla y cristalería brillantes, sin grasa y libre de manchas. Es una fórmula totalmente inocua que limpia y desengrasa sin alterar el medio ambiente, dejando un toque de suavidad en sus manos.
          </p>
          <br/>
      ...
      secondarySlot={<PictureWebp className="" filename="lavavajilla-ozz" description="Imagen del producto lavavajilla neutro ozz "/>}
/>
