...
<SplitSection
      ...
      primarySlot={
        <div className="bg-white bg-opacity-50 rounded-lg px-6 pt-8 pb-6 ml-25">
          <h1 className="font-bold text-xl text-center">Digrizz Ozz </h1>
          <h2 className="font-semibold text-lg text-secondary text-center">desengrasante limpiador multiuso concentrado</h2>
          <p className="mt-8 text-md font-light leading-relaxed text-justify">
          Digrizz Ozz® es un desengrasante limpiador multiusos altamente concentrado, de tal forma, que puede ser diluido en diversas proporciones para lograr resultados sobresalientes. Su poder de limpieza se debe a la sinergia de sus agentes activos que limpian y remueven profundamente la grasa en toda la superficie de aplicación, de manera rápida y eficaz.
          </p>
          <br/>
      ...
      secondarySlot={<PictureWebp className="" filename="digrizz-ozz" description="Imagen del producto digrizz ozz "/>}
/>
