...
<section id="product-line" className="pt-6 bg-gradient-to-br from-gray-300 via-white to-gray-300">
  <div className="container mx-auto">
    ...
    <SplitSection className=""
        ...
        secondarySlot={
          <PictureWebp className="float-right" filename="higiene-de-manos" description="Higiene y deseinfección de manos Unilimpio"/>
        }/>
    <div className="w-full">
      ...
      <div className="flex flex-wrap">
        <div className="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-60">
          ...
          <Link to="/productos/higiene-de-manos/jabon-liquido-sistema-cerrado" className="text-blue-500 inline-flex items-center">
              Jabón Líquido Antibacterial con Sistema Cerrado
            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-4 h-4 ml-2" viewBox="0 0 24 24">
              <path d="M5 12h14M12 5l7 7-7 7"></path>
            </svg>
          </Link><br/>
        ...
        <div className="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-60">
          ...
          <Link to="/productos/higiene-de-manos/gel-antibacterial-sistema-cerrado" className="text-blue-500 inline-flex items-center text-left">
              Gel Antibacterial con Sistema Cerrado
            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-4 h-4 ml-2" viewBox="0 0 24 24">
              <path d="M5 12h14M12 5l7 7-7 7"></path>
            </svg>
          </Link><br/>
