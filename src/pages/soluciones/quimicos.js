...
<section id="product-line" className="pt-6 bg-gradient-to-br from-gray-300 via-white to-gray-300">
  <div className="container mx-auto">
    <h1 className="text-center sm:text-3xl text-2xl font-medium title-font mb-8">Productos Químicos</h1>
    <SplitSection className=""
        primarySlot={
          <div className="bg-white bg-opacity-50 rounded-xl p-8">
            <h2 className="text-xl">Productos químicos seguros y amigables con el medio ambiente.</h2>
            <p className="md:w-full text-left leading-relaxed text-base text-gray-700">
              ...
              Nuestras fórumlas químicas son:
        ...
        secondarySlot={
          <PictureWebp className="float-right" filename="quimicos" description="Productos quimicos Unilimpio"/>
        }/>
      ...
      <div className="flex flex-wrap">
        <div className="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-60">
          ...
          <Link to="/productos/quimicos/organic-100" className="text-blue-500 inline-flex items-center">
              Desinfectante a base de ácidos orgánicos
            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-4 h-4 ml-2" viewBox="0 0 24 24">
              <path d="M5 12h14M12 5l7 7-7 7"></path>
            </svg>
          </Link><br/>
        ...
        <div className="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-60">
          <h3 className="text-lg sm:text-xl font-medium title-font mb-2">
            Detergentes, desengrasantes y limpiadores
          </h3>
          <Link to="/productos/quimicos/digrizz-ozz" className="text-blue-500 inline-flex items-center">
          ...
          <Link to="/productos/quimicos/desengrasante-tornado" className="text-blue-500 inline-flex items-center">
