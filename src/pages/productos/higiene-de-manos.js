...
<section id="product-line" className="pt-6 bg-gradient-to-br from-gray-300 via-white to-gray-300">
  <div className="container mx-auto">
    <h1 className="text-center sm:text-3xl text-2xl font-bold title-font mb-8">Higiene y Desinfección de Manos</h1>
    <SplitSection className=""
        ...
        secondarySlot={
          <PictureWebp className="float-right" filename="higiene-de-manos" description="Higiene y desinfección de manos Unilimpio"/>
        }/>
...
<section id="features" className="py-10 md:py-20 ">
      <div className="container mx-auto">
        <div className="w-full bg-fill bg-no-repeat bg-products">
          <h2 className="text-3xl font-semibold text-center bold">¿Por qué elegir nuestro productos químicos?</h2>
