...
<SplitSection
      ...
      primarySlot={
        <div className="bg-white bg-opacity-50 rounded-lg px-6 pt-8 pb-6 ml-25">
          <h1 className="font-bold text-xl">Dispensador de Lujo para Toalla Z </h1>
          <h2 className="font-semibold text-lg text-secondary">de color negro translúcido.</h2>
      ...
      secondarySlot={<PictureWebp className="" filename="dispensador-toalla-z-lujo" description="Imagen del producto dispensador de lujo para toalla z  "/>}
/>
