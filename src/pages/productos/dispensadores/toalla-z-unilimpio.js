...
<SplitSection
      ...
      primarySlot={
        <div className="bg-white bg-opacity-50 rounded-lg px-6 pt-8 pb-6 ml-25">
          <h1 className="font-bold text-xl text-center">Dispensador para Toalla Z </h1>
          <h2 className="font-semibold text-lg text-secondary text-center">Dispensa una a una la toalla abierta y deja la siguiente lista para ser usada.  </h2>
          <p className="mt-8 text-md font-light leading-relaxed text-justify">
          Dispensador de toallas Z en color gris y blanco. Se caracterizan por su gran capacidad y fácil rellenado de papel toalla, garantizando el buen uso de éste mediante una llave de seguridad, el sistema de dispensado es 100% higiénico. Protege al producto del polvo, la humedad y las bacterias. Es elaborado con polipropileno impermeable contra el moho. Adecuado para poder equipar en cualquier baño público.
          </p>
          <br/>
      ...
      secondarySlot={<PictureWebp className="" filename="dispensador-toalla-z-unilimpio" description="Imagen del producto dispensador para toalla Z Unilimpio"/>}
/>
