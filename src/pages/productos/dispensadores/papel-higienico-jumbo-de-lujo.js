...
<SplitSection
      ...
      primarySlot={
        <div className="bg-white bg-opacity-50 rounded-lg px-6 pt-8 pb-6 ml-25">
          <h1 className="font-bold text-xl text-center">Dispensador de Papel Higiénico Jumbo de Lujo</h1>
          <h2 className="font-semibold text-lg text-secondary text-center">color negro translúcido</h2>
      ...
      secondarySlot={<PictureWebp className="" filename="dispensador-ph-lujo" description="Imagen del producto dispensador de papel higiénico jumbo de lujo "/>}
/>
