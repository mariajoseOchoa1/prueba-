...
<SplitSection
      ...
      primarySlot={
        <div className="bg-white bg-opacity-50 rounded-lg px-6 pt-8 pb-6 ml-25">
          ...
          <h2 className="font-semibold text-lg text-secondary text-center">Extra blanco</h2>
      ...
      secondarySlot={<PictureWebp className="" filename="papel-higienico-jumbo-bio" description="Imagen del producto papel higiénico bio 200 metros "/>}
/>
