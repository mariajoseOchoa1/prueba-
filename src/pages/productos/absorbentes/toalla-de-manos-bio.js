...
<SplitSection
      ...
      primarySlot={
        <div className="bg-white bg-opacity-50 rounded-lg px-6 pt-8 pb-6 ml-25">
          <h1 className="font-bold text-xl text-center">Toalla de Manos Biosolutions </h1>
          <h2 className="font-semibold text-lg text-secondary text-center">color blanca </h2>
      ...
      secondarySlot={<PictureWebp className="" filename="toalla-de-manos-bio" description="Imagen del producto toalla de manos bio"/>}
/>
