...
<SplitSection
      ...
      primarySlot={
        <div className="bg-white bg-opacity-50 rounded-lg px-6 pt-8 pb-6 ml-25">
          <h1 className="font-bold text-xl text-center">Servilleta Biosolutions </h1>
          <h2 className="font-semibold text-lg text-secondary text-center">24x24 cm color blanca </h2>
      ...
      secondarySlot={<PictureWebp className="" filename="servilleta-bio" description="Imagen del producto servilleta bio "/>}
/>
