...
<SplitSection
      ...
      primarySlot={
        <div className="bg-white bg-opacity-50 rounded-lg px-6 pt-8 pb-6 ml-25">
          <h1 className="font-bold text-xl text-center">Jabón Líquido para Relleno Dr.Clean </h1>
      ...
      secondarySlot={<PictureWebp className="" filename="jabon-para-relleno" description="Imagen del producto jabón líquido antibacterial para relleno Dr.Clean "/>}
/>
