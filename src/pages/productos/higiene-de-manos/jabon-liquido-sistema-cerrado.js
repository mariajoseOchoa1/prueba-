...
<SplitSection
      ...
      primarySlot={
        <div className="bg-white bg-opacity-50 rounded-lg px-6 pt-8 pb-6 ml-25">
          <h1 className="font-bold text-xl text-center">Jabón Líquido con Sistema Cerrado Dr.Clean </h1>
          <h2 className="font-semibold text-lg text-secondary text-center">Para una adecuada higiene de manos</h2>
      ...
      secondarySlot={<PictureWebp className="" filename="jabon-sistema-cerrado" description="Imagen del producto jabón líquido antibacterial con sistema cerrado Dr.Clean "/>}
/>
