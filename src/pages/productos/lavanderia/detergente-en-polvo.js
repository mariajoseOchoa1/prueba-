...
<SplitSection
      ...
      primarySlot={
        <div className="bg-white bg-opacity-50 rounded-lg px-6 pt-8 pb-6 ml-25">
          <h1 className="font-bold text-xl text-center">Detergente en Polvo Unilimpio </h1>
          <h2 className="font-semibold text-lg text-secondary text-center">100% libre de fosfatos.</h2>
          <p className="mt-8 text-md font-light leading-relaxed text-justify">
          Detergente en polvo Unilimpio es un detergente de última generación. Brinda un elevado poder de lavado para todo tipo de tejidos (prendas, mantelería, ropa de cama (sabanas, edredones). Está diseñado para proveer un nivel óptimo de espuma y de fácil enjuague. Cuida y protege las prendas blancas y de color gracias a que no contiene cloro, además posee blanqueador óptico. Su fórmula 100% libre de fosfatos es ecológica y cuida el agua. Puede ser utilizado para lavado a mano o en maquina lavadora.
          </p>
          <br/>
      ...
      secondarySlot={<PictureWebp className="" filename="detergente-en-polvo" description="Imagen del producto detergente en polvo Unilimpio "/>}
/>
