...
<SplitSection
      ...
      primarySlot={
        <div className="bg-white bg-opacity-50 rounded-lg px-6 pt-8 pb-6 ml-25">
          <h1 className="font-bold text-xl text-center">Limpiador de Pisos Flotantes Ozz </h1>
          <h2 className="font-semibold text-lg text-secondary text-center">Abrillantador y restaurador de pisos flotantes </h2>
      ...
      secondarySlot={<PictureWebp className="" filename="limpiador-de-piso-flotante" description="Imagen del producto limpiador de pisos flotantes Ozz"/>}
/>
