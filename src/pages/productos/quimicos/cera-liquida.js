...
<SplitSection
      ...
      primarySlot={
        <div className="bg-white bg-opacity-50 rounded-lg px-6 pt-8 pb-6 ml-25">
          <h1 className="font-bold text-xl text-center">Cera Autobrillante Ozz </h1>
          <h2 className="font-semibold text-lg text-secondary text-center">Abrillantador de pisos perfumada </h2>
      ...
      secondarySlot={<PictureWebp className="" filename="cera-liquida" description="Imagen del producto cera líquida autobrillante para pisos Ozz  "/>}
/>
