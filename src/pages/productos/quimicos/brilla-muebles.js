...
<SplitSection
      ...
      primarySlot={
        <div className="bg-white bg-opacity-50 rounded-lg px-6 pt-8 pb-6 ml-25">
          <h1 className="font-bold text-xl text-center">Brilla Muebles Ozz </h1>
          <h2 className="font-semibold text-lg text-secondary text-center">Abrillantador de muebles de hogar y oficina </h2>
      ...
      secondarySlot={<PictureWebp className="" filename="brilla-muebles" description="Imagen del producto brilla muebles Ozz "/>}
/>
